...
//
// Each project body starts with a leading image (left column on the detail
// page), matching the reference site. ThumbnailURLs (and leading image URLs)
// point at public Supabase Storage objects in the project-media bucket
// (seeded via make migrate-media).
var stubProjects = []models.Project{
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/8306c988-3b1e-4293-9929-96ed427acd49/seed.jpg", "alt": "Udacity Accenture"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/56709ace-fbe7-4f19-800b-955e0acd9344/seed.webp", "alt": "Flying Upstream Podcast"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/88cbd9b1-bd07-4b4f-8960-41989b8cfd5f/seed.jpg", "alt": "Future of the Bay- KQED Special"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/8bc8c012-8a92-4ce6-9ef1-9e1f4b573c8b/seed.webp", "alt": "Holi Celebration- Pyarful"},
	...
	},
	{
		...
		Summary: "Featured on Pyarful’s Instagram (30.5K followers)",
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/3da19481-db82-4a47-b58e-5376356b990e/seed.jpg", "alt": "Founder Introduction- Pyarful"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/febd8ad2-946a-4453-aea8-9772171b102a/seed.jpg", "alt": "Biodiversity and Climate Optimist at Heart- PG&E"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/27b93502-495f-4b8e-9f53-8cc90b5d162f/seed.jpg", "alt": "TechWomen- PG&E"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/3d3c3c27-4c4c-47a0-8e55-af23464fcb2a/seed.jpg", "alt": "Saluting Branches- PG&E"},
	...
	},
	{
		...
		Summary: "Featured on PG&E’s YouTube (35.2K subscribers) and Instagram (24K followers)",
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/1cd33d69-ded1-4771-8bd4-f083d5c9b4c6/seed.jpg", "alt": "Beautification- PG&E"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/8e13a7f3-9211-492e-96b9-45248d06ae76/seed.jpg", "alt": "Inside a No-Kill Animal Shelter- KQED"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/b3892e1b-241b-4b7e-a2b1-abba50467472/seed.jpg", "alt": "Comrade is My Pronoun"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/8d2afe07-bb54-485e-b7df-3455752492be/seed.jpg", "alt": "Things to Do at Dolores Park This Summer- KQED"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/a74cc812-e212-4bc4-bef7-2796c9bb9481/seed.jpg", "alt": "Chabot Fire Academy"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/2b35613b-5b7d-434e-8818-1de92896c690/seed.jpg", "alt": "Gorast Droll"},
	...
	},
	{
		...
		Body: []models.RichTextBlock{
			{"type": "image", "url": "https://qsckqwxajgpxpzvlerdg.supabase.co/storage/v1/object/public/project-media/projects/b776016f-b7b9-4921-b79e-0bd500c00968/seed.jpg", "alt": "City Surf Project"},
